...
使用Visual Studio调试时需要在Windows的功能启用.net framework 3.5，Visual Studio需要有.net framrwork 3.5或以上版本SDK与目标包
Visual Studio单个组件安装 适用于最新 vXXX 生成工具的 C++ MFC (x86 和 x64)
...
Release 1.0.3 - 2024-09-23
===========================
修复一个端口同时转发udp与tcp时修改第二条时变成新增问题
